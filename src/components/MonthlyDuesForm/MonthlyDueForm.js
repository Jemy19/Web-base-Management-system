...
<Form id="MonthlyDueForm-Form" className="text-center w-100">
    <h3>MonthlyDue Form</h3>

    <Form.Group controlId="Fullname">
    <FloatingLabel controlId="floatingInput" label="Full Name" className="mb-3">
          <Form.Control type="fullname" size="lg" placeholder="Fullname" autoComplete="fullname" className="position-relative" />
          </FloatingLabel>
        </Form.Group>
        ...
        <Form.Control aria-label="Text input with dropdown button" value = {value}/>
      </InputGroup>
