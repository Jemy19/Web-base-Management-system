...
declare const useGridVirtualRows: (apiRef: GridApiRef, props: Pick<GridComponentProps, 'pagination' | 'paginationMode' | 'columnBuffer' | 'disableExtendRowFullWidth'>) => void;
...
declare const useGridContainerProps: (apiRef: GridApiRef, props: Pick<GridComponentProps, 'pagination' | 'autoPageSize' | 'pageSize' | 'autoHeight' | 'hideFooter' | 'scrollbarSize'>) => void;
